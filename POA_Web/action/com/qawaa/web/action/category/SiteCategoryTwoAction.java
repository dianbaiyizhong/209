...
/**
 * @author Ryan  2013-10-8  上午12:35:38
...
public class SiteCategoryTwoAction extends BaseAction {
	...
	/**
	 * @param categorySiteTwoService the categorySiteTwoService to set
	 */
	public void setCategorySiteTwoService(CategorySiteTwoService categorySiteTwoService) {
	...
	/**
	 * @param class1_id the class1_id to set
	 */
	...
	/**
	 * @param class2s the class2s to set
	 */
	...
	public String execute() throws Exception {
		...
		this.class2es = categorySiteTwoService.getCategorySiteTwoByParamsAndPage(params, 0, 100);
