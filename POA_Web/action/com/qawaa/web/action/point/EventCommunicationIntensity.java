...
public class EventCommunicationIntensity extends BaseAction {
	...
	/**
	 * @param pointEventIntensityService the pointEventIntensityService to set
	 */
	public void setPointEventIntensityService(PointEventIntensityService pointEventIntensityService) {
	...
	public String singleIntensity(){
		...
		this.intensity = pointEventIntensityService.getLastIntensityByEvent(event_id);
		this.total = 1;
		return SUCCESS;
	}
}
