...
/**
 * @author Ryan  2010-6-7  下午02:21:33
 *
 */
public class StringUtil {
	...
	/**
	 * 根据最长长度截取字符串
	 * maxLength小于0时 返回原字符串
	 * maxLength大于字符串长度时 返回原字符串
	 * 
	 * @param s 需要处理的字符串
	 ...
	 * @param array 数组，array = null 或者array.length=0时返回长度为0的字符串
	 * @param split split为null时不使用间隔符
	 * @return
	 */
