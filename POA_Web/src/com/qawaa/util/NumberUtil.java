...
/**
 * @author Ryan  2010-6-10  下午05:15:49
 * 数字类型处理类
 */
public class NumberUtil {
	...
	public static Integer string2Integer(String s, Integer defaultInteger){
		...
		try{
			...
			LOG.error("类型转换错误! MESSAGE:" + s + " TO " + "Integer; 使用默认值：" + defaultInteger);
			i = defaultInteger;
		}
		return i;
	}
	...
	/**
	 * 将Long类型转换为Integer类型。如果超出Integer的最大范围，则返回Integer.MAX_VALUE;如果小于Integer的最小范围，则返回Integer.MIN_VALUE。
	 * @param i 需要进行转换的数值。如果i为空，则返回0
	 * @return
	 */
