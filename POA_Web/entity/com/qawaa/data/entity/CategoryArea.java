...
public class CategoryArea implements java.io.Serializable {
	...
	/** minimal constructor */
	public CategoryArea(Integer cgaId, String cgaName, Boolean cgaStatus, Integer cgaOrder) {
		this.cgaId = cgaId;
	...
	/** full constructor */
	public CategoryArea(Integer cgaId, String cgaName, String cgaComment, Boolean cgaStatus, Integer cgaOrder) {
		this.cgaId = cgaId;
		this.cgaName = cgaName;
