...
public class EventList implements java.io.Serializable {
	 ...
	 * @param eventRecovery
	 */
	public EventList(Integer eventId, String eventTitle, Integer eventStatus, String eventCategory, String eventKeyword, Integer eventExpand, Timestamp eventStart, Timestamp eventExp, Boolean eventTop, Integer eventOrder, Timestamp eventDate, Timestamp eventScanDate, Integer eventParent, Boolean eventRecovery) {
		super();
	 ...
	 * @param eventRecovery
	 */
	public EventList(Integer eventId, String eventTitle, String eventShortTitle, String eventAbstract, Integer eventStatus, String eventCategory, String eventKeyword, Integer eventExpand, Timestamp eventStart, Timestamp eventExp, Boolean eventTop, Integer eventOrder, Timestamp eventDate, Timestamp eventScanDate, Integer eventParent, Boolean eventRecovery) {
		super();
		this.eventId = eventId;
		this.eventTitle = eventTitle;
