...
public class EventListDaoImpl extends HibernateDaoSupport implements EventListDao {
	...
	/* (non-Javadoc)
	 * @see org.cischina.dao.EventListDao#getRecommendEvents()
	 */
	@SuppressWarnings("unchecked")
	@Override
	public List<EventList> getRecommendEvents() {
		String hql = "from EventList where eventStatus = ? or eventStatus = ? and eventRecovery = ? order by eventTop desc, eventOrder desc";
