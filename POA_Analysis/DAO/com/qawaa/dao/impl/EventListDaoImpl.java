...
public class EventListDaoImpl extends HibernateDaoSupport implements
	...
	/* (non-Javadoc)
	 * @see com.qawaa.dao.EventListDao#update(com.qawaa.data.entity.EventList)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.qawaa.dao.EventListDao#getCountByParams(java.util.Map)
	 */
	@SuppressWarnings("unchecked")
	@Override
